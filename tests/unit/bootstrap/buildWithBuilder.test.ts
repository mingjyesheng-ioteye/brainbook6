...
describe('build-with-builder', () => {
  it('verifies the executable name generated by electron-builder', () => {
    ...
    expect(observability).toContain('!define AIONUI_APP_EXECUTABLE_FILENAME "${APP_EXECUTABLE_FILENAME}"');
