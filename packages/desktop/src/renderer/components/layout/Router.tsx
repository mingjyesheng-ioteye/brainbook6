...
const BrainbookSettings = React.lazy(() => import('@renderer/pages/settings/BrainbookSettings'));
    ...
    <HashRouter>
      <Routes>
        ...
        <Route element={<ProtectedLayout layout={layout} />}>
          ...
          <Route path='/settings/brainbook' element={withRouteFallback(BrainbookSettings)} />
